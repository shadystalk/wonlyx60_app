...
import com.wl.wlflatproject.MUtils.DensityUtil;
...
//        textSize=mTypedArray.getInteger(R.styleable.SlideToUnlockView_textSize, 7);
    ...
    protected void initView() {
        ...
        LayoutInflater.from(mContext).inflate(R.layout.slid_layout,
                this, true);
...
//                        logI(TAG, "mSlidedDistance============================="+ mSlidedDistance);
                        ...
                        if (mSlidedDistance > 0 &&mSlidedDistance<i) {//直接通过margin实现滑动
...
//                        }
    ...
    private void scrollToRight(final View v) {
        ...
        ViewAnimator
                ...
                .translationX(ViewHelper.getTranslationX(v), ( iv_slide.getWidth() - params1.leftMargin-slideImageViewWidth))
