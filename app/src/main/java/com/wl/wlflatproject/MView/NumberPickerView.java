 ...
 * @Time: 2019/7/2 9:02
 * @E-mail: xxx@163.com
 * @Description: https://github.com/Carbs0126/NumberPickerView
 */
public class NumberPickerView extends View {
    ...
    private static final int DEFAULT_MARGIN_START_OF_HINT_DP = 3;
    ...
    private void init(Context context) {
        ...
        // TODO: 2019/7/3  
        if (mTextColorSelected != Color.parseColor("#666666")) {
    ...
    private void drawHint(Canvas canvas) {
        ...
        // TODO: 2019/7/3 微调
        float offsetY = getResources().getDimension(R.dimen.dp_2);
        canvas.drawText(mHintText,
                mViewCenterX + (mMaxWidthOfDisplayedValues + mWidthOfHintText) / 2 + mMarginStartOfHint,
                (dividerY0 + dividerY1) / 2 + mTextSizeHintCenterYOffset + offsetY, mPaintHint);
    }
