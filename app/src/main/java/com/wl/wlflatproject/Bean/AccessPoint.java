...
public class AccessPoint implements Parcelable, Comparable<AccessPoint> {
    ...
    public static final int SIGNAL_LEVELS = 3;
    ...
    public String getStatusSummary() {
        if (isActive()) {
            ...
            if (state == null) {
                return context.getString(R.string.setting_network_wifi_status_idle);
            }
            if (state == NetworkInfo.DetailedState.CONNECTED) {
                ...
                if (networkCapabilities != null && !networkCapabilities.hasCapability(NetworkCapabilities.NET_CAPABILITY_VALIDATED)) {
                    return context.getString(R.string.setting_network_wifi_status_connected_no_internet);
                }
            }
            switch (state) {
                case IDLE:
                    return context.getString(R.string.setting_network_wifi_status_idle);
                case SCANNING:
                    return context.getString(R.string.setting_network_wifi_status_scanning);
                case CONNECTING:
                    return context.getString(R.string.setting_network_wifi_status_connecting);
                case AUTHENTICATING:
                    return context.getString(R.string.setting_network_wifi_status_authenticating);
                case OBTAINING_IPADDR:
                    return context.getString(R.string.setting_network_wifi_status_obtaining_ip_address);
                case CONNECTED:
                    isPasswordError = false;
                    return context.getString(R.string.setting_network_wifi_status_connected);
                case SUSPENDED:
                    return context.getString(R.string.setting_network_wifi_status_suspended);
                case DISCONNECTING:
                    return context.getString(R.string.setting_network_wifi_status_disconnecting);
                case DISCONNECTED:
                    return context.getString(R.string.setting_network_wifi_status_disconnected);
                case FAILED:
                    return context.getString(R.string.setting_network_wifi_status_failed);
                case BLOCKED:
                    return context.getString(R.string.setting_network_wifi_status_blocked);
                case VERIFYING_POOR_LINK:
                    return context.getString(R.string.setting_network_wifi_status_verifying_poor_link);
            ...
            switch (getNetworkSelectionDisableReason()) {
                case 2:
                    return context.getString(R.string.setting_network_wifi_status_disabled);
                case 3:
                    return context.getString(R.string.setting_network_wifi_status_password_failure);
                case 4:
                case 5:
                    return context.getString(R.string.setting_network_wifi_status_network_failure);
                default:
                    return context.getString(R.string.setting_network_wifi_status_wifi_failure);
            }
        } else if (isSaved()) {
            return context.getString(R.string.setting_network_wifi_status_saved);
        } else {
            return context.getString(R.string.setting_network_wifi_status_idle);
        }
    }
    ...
    public void generateNetworkConfig() {
        ...
        switch (security) {
            ...
            case SECURITY_EAP:
                ...
                wifiConfiguration.enterpriseConfig.setPhase2Method(WifiEnterpriseConfig.Phase2.NONE);
                // 设置密码
    ...
    public void generateNetworkConfigNoPwd() {
        if (wifiConfiguration != null) {
    ...
    public int compareTo(@NonNull AccessPoint other) {
        ...
        if (this.rssi != Integer.MAX_VALUE && other.rssi == Integer.MAX_VALUE) {
            return -1;
        }
        if (this.rssi == Integer.MAX_VALUE && other.rssi != Integer.MAX_VALUE) {
            return 1;
